...
<body>
				...
				<form name="form" id="form" method="post" enctype="multipart/form-data">
					...
					<tr>
						...
						<td colspan="7">
							...
							<div style="float:right;"><span id="add" class="input-group-addon" style="background-color: #f0ad4e;  height:30px;"><i class="glyphicon glyphicon-plus" style="color:white;"></i></span></div>
						</td>
					</tr>	
					</table>
	...
	<script type="text/javascript">
		...
		$("#add").click(function() {
			if(count<4){
				$("#frmTable").append('<tr><td class="tdWidth"><label>사진'+(count+2)+'</label></td><td colspan="7"><div class="input-group col-lg-9"><input type="file" name="f1" class="form-control"><span class="input-group-addon"><i class="glyphicon glyphicon-remove del" ></i></span></div></td></tr>');
				count++;
			}else if(count==4){
